...
export default function Main() {
  return (
    <div className="flex items-center h-full pb-16 main-page">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 gap-5 mt-16">
          ...
          <div className="right">
            <div className="flex items-center justify-between p-5 rounded-md cursor-pointer budget bg-green-default">
            ...
            <div className="flex items-center justify-between p-5 mt-3 rounded-md cursor-pointer budget bg-blue-default">
            ...
            <div className="flex items-center justify-between p-5 mt-3 rounded-md cursor-pointer budget bg-pink-default">
              <h4 className="d4 text-white-default">
